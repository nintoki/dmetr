...
export default class Phases extends Component {
    ...
    return (
			<div className={phase.code === null ? "hidden" : ""}>
				...
				<div className={ (phase.op1_1 == 0 || phase.op1_2 == 0 || phase.op1_3 == 0 || phase.op1_4 == 0 || phase.op1_5 == 0 || phase.op1_1 == 1 && phase.op1_2 == 1 && phase.op1_3 == 1 && phase.op1_4 == 1 && phase.op1_5 == 1 && phase.op2_1 == 1 && phase.op2_2 == 1 && phase.op2_3 == 1 && phase.op2_4 == 1 && phase.op2_5 == 1) ? "hidden" : "op2-min"}>
					<div className="opdiv-min">
						<div className="optit">sn.Rx</div>
						<div className={phase.op2_5 == 1 ? "op-comp" : "op-open"}></div>
					</div>
					<div className="opdiv-min">
				...
				<div className={(phase.op1_1 == 0 || phase.op1_2 == 0 || phase.op1_3 == 0 || phase.op1_4 == 0 || phase.op1_5 == 0 || phase.op2_1 == 0 || phase.op2_2 == 0 || phase.op2_3 == 0 || phase.op2_4 == 0 || phase.op2_5 == 0 || phase.op3_1 == 1 && phase.op3_2 == 1 && phase.op3_3 == 1 && phase.op3_4 == 1 ) ? "hidden" : "op3-min" }>
					<div className="opdiv-min">
				...
				<div className={(phase.op1_1 == 1 && phase.op1_2 == 1 && phase.op1_3 == 1 && phase.op1_4 == 1 && phase.op1_5 == 1 && phase.op2_1 == 1 && phase.op2_2 == 1 && phase.op2_3 == 1 && phase.op2_4 == 1 && phase.op2_5 == 1 && phase.op3_1 == 1 && phase.op3_2 == 1 && phase.op3_3 == 1 && phase.op3_4 == 1 ) ? "" : "hidden" }><strong className="red">Completed - Please archive</strong></div>
			</div>
    );
  }
}
